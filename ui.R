             ...
             fluidPage(
                ...
                fluidRow(
                    ...
                    column(4,
                           ...
                           HTML("<h5><a href='https://www.cdph.ca.gov/Programs/CID/DCDC/Pages/Immunization/ncov2019.aspx' target='_blank'>CDPH COVID-19 Page</a>  |  <a href='https://covid19.ca.gov/' target='_blank'>ca.gov COVID-19 Page</a></h5>")
                    ),
                    column(4,
                           img(src = 'calcat_logo.gif', align = "right"),
                           br()
